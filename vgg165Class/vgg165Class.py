...
val_batches   = ImageDataGenerator().flow_from_directory(val_path, target_size=(224,224),
...
his = new_model.fit_generator(train_batches, validation_data=val_batches, epochs = 200, verbose=3)
loss = his.history['loss']
plt.plot(loss)

model_json = new_model.to_json()
with open('vgg165ClassArchitechture.json','w') as file:
    file.write(model_json)

new_model.save_weights('vgg156ClassWeights.h5')
